 ...
 *
 * Subset shipped in this fork: Anthropic (api-key auth, restored locally,
 * does NOT need pi-ai OAuth) plus the env-key providers. Gemini, Codex,
 * Exa-MCP, and Parallel were dropped because they pull in too much
 * pi-ai OAuth machinery to vendor cleanly. Restore those once the
 * pi-ai surface is vendored.
 */
const PROVIDER_META: Partial<Record<SearchProviderId, ProviderMeta>> = {
	anthropic: {
		id: "anthropic",
		label: "Anthropic",
